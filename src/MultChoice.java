...
public class MultChoice implements ActionListener{

    String[] questions = 	{
            // in reality it would be ( "Question 1:" + string variable from option list that has the question)
            "Question 1",
            "Question 2",
            "Question 3",
            "Question 4"
    ...
    public MultChoice() {
        ...
        time_label.setBackground(new Color(50,50,20));
        time_label.setForeground(new Color(25,255,255));
        time_label.setFont(new Font("Arial",Font.PLAIN,16));
        time_label.setHorizontalAlignment(JTextField.CENTER);
        time_label.setText("timer");

        number_right.setBounds(225,225,200,100);
        number_right.setBackground(new Color(25,25,20));
        ...
        percentage.setBackground(new Color(25,25,20));
...
public class MultChoice extends JFrame implements ActionListener {
    ...
    MultChoice() {
        ...
        label.setBounds (280,100,360,50);
        //title setFont(new Font ("Times New Roman", Font.BOLD, 28));
        //label.setBorder(new EmptyBoarder(0,10,0,0));

        bton = new JButton ("Check Answer");
        bton.setBounds (300,420,250,50);


        button = new JButton("Option 1");
        button.setBounds (270,200,300,50);

        buttonTwo = new JButton("Option 2");
        buttonTwo.setBounds(270,250,300,50);

        buttonThree = new JButton ("Option 3");
        buttonThree.setBounds(270,300,300,50);

        buttonFour = new JButton ("Option 3");
        buttonFour.setBounds(270,350,300,50);
